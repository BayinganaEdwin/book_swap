...
class _BookDetailScreenState extends State<BookDetailScreen> {
  ...
  Future<void> _handleRequestSwap(
    ...
    // Show dialog to select a book to swap
    final selectedBook = await _showBookSelectionDialog(context, bookProv, auth.user!.uid);
  ...
  Future<Book?> _showBookSelectionDialog(
      BuildContext context, BookProvider bookProv, String userId) async {
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<List<Book>>(
                  stream: bookProv.myAvailableBooks(userId),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              Text(
                                'You need at least one available book to swap',
                                style: TextStyle(
                                  fontSize: 14,
